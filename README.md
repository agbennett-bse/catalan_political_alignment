...
Below you can see the ability of the classifier to determine PP vs PSOE (main left and right parties in Spain), and also the trained models ability to determine the difference between VOX and Podemos. You can see a full write up in the pdf in this repository. 
